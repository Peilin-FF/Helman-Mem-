...
The 0% baseline is the clean source stream in data/counterfactual_source.

Output: data/counterfactual_build/per_dataset/p{50,70,90}/{dataset}.jsonl
"""
...
def main() -> None:
    ...
    ap.add_argument(
        "--in_dir",
        default="data/counterfactual_source",
        help="directory with graded {dataset}.jsonl files",
    )
    ap.add_argument("--out_dir", default="data/counterfactual_build/per_dataset")
