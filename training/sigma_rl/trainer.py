    ...
    def fit(self):
        ...
        for epoch in range(self.config.trainer.total_epochs):
            ...
            for batch_dict in dl_iter:
                ...
                if "extra_info" in batch.non_tensor_batch:   # evidence seeking (method B): the rollout runs the model's check on each event's record
                    gen_batch.non_tensor_batch["extra_info"] = batch.non_tensor_batch["extra_info"].copy()
