...
try:
    import pymysql
except ImportError:  # kalman-mem: MySQL is not used here
    pymysql = None
...
DB_CONFIG = {
    ...
    "port": int(os.environ.get("KALMAN_PG_PORT", 5432)),   # kalman-mem: the cluster of this run
    # "dbtype": "postgresql"
}
