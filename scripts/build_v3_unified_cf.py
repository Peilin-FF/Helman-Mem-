...
Differences vs scripts/build_v3_counterfactuals.py (which this reuses):
...
Output: data/v3_unified/p{0,50,70,90}.jsonl  +  data/v3_unified/build_stats.json
...
from scripts.build_v3_counterfactuals import (
    DATASETS,
    PROPORTIONS,
    MAX_P,
    _seed,
...
def main() -> None:
    ...
    ap.add_argument("--in_dir", default="data/v3/graded")
