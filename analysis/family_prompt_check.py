...
blocks, and report how completely the tilt covers them.  Run before any GPU time is spent on a new family.
    ...
    PYTHONPATH=. python -m analysis.family_prompt_check --models /mnt/data/peilin/HF_MODEL/phi-4 ... [--k 100]
"""
...
def main() -> None:
    ...
    ap.add_argument("--prompts", default="outputs/record/q3_4b/indist6/shuffled0.fit-train6.jsonl")
