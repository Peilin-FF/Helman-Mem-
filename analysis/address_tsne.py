...
def main():
    ...
    ap.add_argument("--train", default="outputs/features/q3_4b/train6/shard*.pt")
    ap.add_argument("--test", default="outputs/features/q3_4b/indist6/shard*.pt")
    ap.add_argument("--stream_name", default="in-distribution test stream")
    ap.add_argument("--out", default="outputs/analysis/tsne_q3_4b_indist6")
