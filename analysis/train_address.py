...
projections are the slow weights, the memory state the fast weights.
  ...
  PYTHONPATH=. python -m analysis.train_address --model q3_4b --stream train6 --dim 64 --episodes 400 --episode_len 512 \
      --out outputs/analysis/address/q3_4b_d64.pt
"""
...
def main() -> None:
    ...
    ap.add_argument("--stream", default="train6")
