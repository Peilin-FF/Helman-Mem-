...
MODELS = [
    ("frozen",        "outputs/eval/q3_4b/{s}/{c}"),
    ("ours",          "outputs/eval/run3b_tilt/{s}/{c}"),
    ("control",       "outputs/eval/ctrl3b_peers/{s}/{c}"),
    ("question-only", "outputs/eval/solo3b_q/{s}/{c}"),
]
...
def main() -> None:
    ...
    ap.add_argument("--stream", default="ood6", choices=["ood6", "indist6"])
