"""Summarise analysis/attention_mass.py outputs into one table per stream (see that file for the metrics)."""
...
def main() -> None:
    ...
    ap.add_argument("--dir", default="outputs/analysis/attention_mass")
